...
data_root = '/home/jovyan/code/jtalmansa/CU-07/BinaryData/LEVIR-CD+' #'data/LEVIR-CD'
...
model = dict(
    ...
    decode_head=dict(
        ban_cfg=dict(
            ...
            side_enc_cfg=dict(
                ...
                in_channels=3,
                init_cfg=dict(
                    checkpoint='pretrain/mit_b0_20220624-7e0fe6dd.pth',
                    type='Pretrained'),
                mlp_ratio=4,
                num_heads=[
                    1,
    ...
    image_encoder=dict(
        ...
        with_cls_token=True),
    pretrained='pretrain/clip_vit-large-patch14-336_3rdparty-0b5df9cb.pth',
...
work_dir = './work_dirs/ban_vit-l14-clip_mit-b0_512x512_40k_levircd'
